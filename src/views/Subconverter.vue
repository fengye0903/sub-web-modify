  ...
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "自用专属后端【vless reality+hy1+hy2】": "https://subapi.307986.xyz",
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://subapi.307986.xyz" : this.getUrlParam(),
